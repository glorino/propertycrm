...
const demoUsers = [
  { email: "admin@propertycrm.com", password: "admin123", name: "Alex Johnson", role: "super_admin", team: "AI Operations" },
  { email: "marcus@propertycrm.com", password: "demo123", name: "Marcus Johnson", role: "admin", team: "Support Engineering" },
  { email: "sarah@propertycrm.com", password: "demo123", name: "Sarah Kim", role: "manager", team: "Billing & Accounts" },
  { email: "emily@propertycrm.com", password: "demo123", name: "Emily Rodriguez", role: "manager", team: "Customer Success" },
  { email: "tom@propertycrm.com", password: "demo123", name: "Tom Chen", role: "agent", team: "Support Engineering" },
  { email: "lisa@propertycrm.com", password: "demo123", name: "Lisa Park", role: "agent", team: "Support Engineering" },
  { email: "david@propertycrm.com", password: "demo123", name: "David Kim", role: "agent", team: "Billing & Accounts" },
  { email: "rachel@propertycrm.com", password: "demo123", name: "Rachel Green", role: "agent", team: "Customer Success" },
  { email: "mike@propertycrm.com", password: "demo123", name: "Mike Davis", role: "agent", team: "Support Engineering" },
  { email: "viewer@propertycrm.com", password: "demo123", name: "Jordan Lee", role: "viewer", team: null },
];
...
const demoKnowledgeArticles = [
  ...
  { title: "How to Upgrade or Downgrade Your Plan", content: "To change your plan, go to Settings > Billing > Subscription. Click 'Change Plan' and select your desired tier. Upgrades take effect immediately and you'll be charged a prorated amount. Downgrades take effect at the end of your current billing cycle. All plan features are listed on our pricing page. Contact sales@propertycrm.com for Enterprise custom plans.", collection: "Account & Billing", status: "published", views: 1567, ai_used: 112, helpful: 90, tags: ["plan", "upgrade", "downgrade", "subscription", "pricing"] },
  { title: "Requesting a Refund", content: "We offer refunds within 14 days of purchase if you're unsatisfied. To request a refund, email billing@propertycrm.com with your account email, invoice number, and reason for the refund. Refunds are processed within 5-7 business days to your original payment method. Note: refunds are not available for partial month usage after the 14-day window.", collection: "Account & Billing", status: "published", views: 743, ai_used: 54, helpful: 85, tags: ["refund", "billing", "money-back"] },
  ...
  { title: "Configuring the Web Chat Widget", content: "Embed the chat widget on your website by adding a single script tag to your HTML: <script src='https://cdn.propertycrm.com/chat-widget.js' data-key='YOUR_KEY'></script>. Customize the widget appearance in Settings > Channels > Web Chat. You can change colors, position, welcome message, and pre-chat form fields. The widget supports mobile responsive design and agent handoff.", collection: "Integrations", status: "published", views: 1987, ai_used: 143, helpful: 93, tags: ["webchat", "widget", "embed", "integration"] },
  { title: "Integrating Facebook Messenger", content: "Connect your Facebook Page to PropertyCRM via Settings > Channels > Facebook Messenger. You'll need to authenticate with your Facebook account and select the page you want to connect. Messenger conversations will appear in your unified inbox alongside other channels. AI agents can respond to Messenger inquiries automatically using your knowledge base.", collection: "Integrations", status: "published", views: 1654, ai_used: 121, helpful: 87, tags: ["messenger", "facebook", "integration"] },
  ...
  { title: "Understanding Sentiment Analysis", content: "PropertyCRM's sentiment agent analyzes every message in real-time, detecting emotions like positive, neutral, negative, angry, and frustrated. Sentiment scores range from -1 (very negative) to +1 (very positive). The system uses natural language processing trained on customer support data. Sentiment trends are tracked over time to identify patterns. Use sentiment data to prioritize at-risk customers and improve response strategies.", collection: "Technical Docs", status: "published", views: 2345, ai_used: 189, helpful: 91, tags: ["sentiment", "ai", "analysis", "nlp"] },
  { title: "REST API Documentation Overview", content: "PropertyCRM provides a comprehensive REST API for programmatic access. Base URL: https://api.propertycrm.com/v1. Authentication: Bearer token in Authorization header. Key endpoints: /tickets (CRUD), /customers (CRUD), /knowledge (search), /analytics (reports). Rate limits: 1000 requests/minute. Full documentation at docs.propertycrm.com/api. SDKs available for Node.js, Python, PHP, and Go.", collection: "API Reference", status: "published", views: 4567, ai_used: 345, helpful: 93, tags: ["api", "rest", "documentation", "developers"] },
...
export async function POST() {
  try {
    ...
    for (let i = 0; i < demoTickets.length; i++) {
      ...
      const assigneeId = userIdMap["tom@propertycrm.com"];
    ...
    const adminUserId = userIdMap["admin@propertycrm.com"];
    ...
    return NextResponse.json({
      ...
      logins: {
        ...
        manager: "sarah@propertycrm.com / demo123",
        agent: "tom@propertycrm.com / demo123",
        viewer: "viewer@propertycrm.com / demo123",
      },
    });
  } catch (error) {
