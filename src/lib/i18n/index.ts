...
export const translations = {
  ...
  meetAI: {
    label: { en: "Meet Property AI", fr: "Découvrez Property AI" },
    title: { en: "The intelligence layer behind every decision", fr: "La couche d'intelligence derrière chaque décision" },
    desc: {
      en: "Property AI is the engine PropertyCRM is built on. Trained on real property signals — it classifies, routes, monitors, and resolves so your team can focus on complex issues.",
      fr: "Property AI est le moteur sur lequel PropertyCRM est construit. Entraîné sur de vrais signaux immobiliers — il classe, route, surveille et résout pour que votre équipe puisse se concentrer sur les problèmes complexes.",
    },
  },
  security: {
    ...
    desc: {
      en: "PropertyCRM is built to meet data protection, property regulation, and compliance requirements of real estate agencies, property managers, and institutions globally.",
      fr: "PropertyCRM est conçu pour répondre aux exigences de protection des données, de réglementation immobilière et de conformité des agences immobilières, gestionnaires de propriétés et institutions du monde entier.",
    },
  },
  integrations: {
    ...
    desc: {
      en: "Connect PropertyCRM to your existing tools in minutes — communication channels, automation platforms, cloud services, and CRMs. No rip-and-replace.",
      fr: "Connectez PropertyCRM à vos outils existants en quelques minutes — canaux de communication, plateformes d'automatisation, services cloud et CRM. Pas de remplacement.",
    },
    apiCta: { en: "Explore the API", fr: "Explorer l'API" },
    noTool: { en: "Don't see your tool? PropertyCRM exposes a full REST API — connect anything in your stack.", fr: "Vous ne voyez pas votre outil? PropertyCRM expose une API REST complète — connectez n'importe quoi dans votre pile." },
  },
  cta: {
    ...
    desc: { en: "Every ticket is a promise. PropertyCRM makes sure you keep it.", fr: "Chaque ticket est une promesse. PropertyCRM s'assure que vous la tenez." },
  ...
  channelsPage: {
    ...
    developer: {
      ...
      desc: { en: "PropertyCRM provides a clean, intuitive API that makes channel integration effortless. One endpoint per channel, consistent response formats, and comprehensive documentation.", fr: "PropertyCRM fournit une API propre et intuitive qui rend l'intégration des canaux sans effort. Un endpoint par canal, formats de réponse cohérents et documentation complète." },
  ...
  aboutPage: {
    title: { en: "About PropertyCRM", fr: "À propos de PropertyCRM" },
    ...
    mission: {
      ...
      desc: { en: "PropertyCRM empowers real estate businesses to deliver exceptional client experiences through intelligent automation. We believe every client interaction is an opportunity to build trust, and AI is the key to making that happen at scale.", fr: "PropertyCRM permet aux entreprises immobilières d'offrir des expériences client exceptionnelles grâce à l'automatisation intelligente. Nous croyons que chaque interaction client est une occasion de bâtir la confiance." },
    },
    values: {
    ...
    story: {
      ...
      p1: { en: "Founded in Nigeria, PropertyCRM was born from the frustration of managing property support across too many channels. We watched real estate businesses struggle with fragmented tools, missed inquiries, and unhappy clients.", fr: "Fondée au Nigéria, PropertyCRM est née de la frustration de gérer le support immobilier sur trop de canaux. Nous avons vu des entreprises lutter avec des outils fragmentés." },
      p2: { en: "We built the platform we wished existed — a single place where AI handles the repetitive work, agents focus on what matters, and no client ever feels ignored. Today, PropertyCRM powers support for hundreds of real estate teams across Africa and beyond.", fr: "Nous avons construit la plateforme que nous aurions aimé voir exister — un endroit où l'IA gère le travail répétitif et aucun client ne se sent jamais ignoré." },
    ...
    numbers: {
      ...
      teams: { en: "Teams Using PropertyCRM", fr: "Équipes utilisant PropertyCRM" },
  ...
  landing: {
    ...
    steps: {
      ...
      classify: { title: { en: "Classify", fr: "Classification" }, desc: { en: "Property AI detects intent, sentiment, and urgency in under 50ms. Routes to the right queue.", fr: "Property IA détecte l'intention, le sentiment et l'urgence en moins de 50ms. Route vers la bonne file." } },
  ...
  misc: {
    poweredBy: { en: "PropertyCRM-powered delivery", fr: "Livraison propulsée par PropertyCRM" },
  ...
  footer: {
    desc: { en: "AI-powered property support platform. Built for real estate teams that move fast.", fr: "Plateforme de support immobilier alimentée par l'IA. Construite pour les équipes immobilières qui avancent vite." },
    ...
    copyright: { en: "© 2026 PropertyCRM. All rights reserved.", fr: "© 2026 PropertyCRM. Tous droits réservés." },
  },
  loginPage: {
    ...
    testimonial: { en: "PropertyCRM cut our response time by 73% and our team can focus on complex property issues instead of repetitive questions.", fr: "PropertyCRM a réduit notre temps de réponse de 73% et notre équipe peut se concentrer sur les problèmes immobiliers complexes." },
    testimonialRole: { en: "Head of Support, PropertyCRM", fr: "Directeur du Support, PropertyCRM" },
  ...
  dashboardPage: {
    ...
    welcomeBack: { en: "Welcome back, {name}. Here's your PropertyCRM support overview.", fr: "Bon retour, {name}. Voici votre aperçu du support PropertyCRM." },
    export: { en: "Export", fr: "Exporter" },
